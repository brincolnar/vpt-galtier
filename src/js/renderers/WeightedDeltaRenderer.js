...
_integrateFrame() {
    ...
    console.log('majorant')
    console.log(this.majorant)

    gl.uniform1f(uniforms.uMajorantExtinction, this.majorant);
    
    console.log('extinction')
    console.log(this.extinction)

    gl.uniform1f(uniforms.uExtinction, this.extinction);

    console.log('sigma_s')
    console.log(this.sigma_s)
    
    gl.uniform1f(uniforms.uSigmaS, this.sigma_s);
